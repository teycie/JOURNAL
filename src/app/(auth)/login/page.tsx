    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md glass-panel p-8">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-serif font-semibold text-center">Welcome Back</h1>
          <p className="text-gray-500 mt-2 text-center">Continue your journaling journey.</p>
        </div>
        ...
        <form className="space-y-4">
          ...
          <button formAction={login} className="w-full btn-primary mt-6">
            Sign In
          </button>
        </form>
